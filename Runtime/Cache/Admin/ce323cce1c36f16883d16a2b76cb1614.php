    ...
    <body>
        ...
        $(function(){
            $("#tabbar-div span").click(function(){       
                $("#tabbar-div span").attr('class','tab-back');//将所有标题栏置为暗                
                $(this).attr('class','tab-front');//再将当前的标题栏置为亮
                $(".table_a").hide();//所有的table页隐藏
                var idflag = $(this).attr('id');//当前被点击菜单的table
                $('#'+idflag+'-tb').show();
            });
        });
        </script>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/index.php/Admin/Goods/add.html" method="post" enctype="multipart/form-data">
